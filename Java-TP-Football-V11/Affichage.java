...
public class Affichage
{
    public static void main(String[] args)
    {
        ...
        Equipe equipehome= new Equipe(joueurtesthome,"pays1");
        ...
        Equipe equipeaway= new Equipe(joueurtestaway,"pays2");
        Match match=new Match(equipehome,equipeaway,new GregorianCalendar(2023,0,1),new Olona("Arbitre",34,'m'));

        Fenetre fenetre= new Fenetre(match);

        //corner shoot button
        //precise shoot button
        //goal shoot button
        //two keys in once
        //stop all button
